...
<div id="table">
	...
	?>
			...
			?>
	<a href="?module=relatorios&acao=rel_adm&semestre=<?php echo $sem?>" style="margin-left:600px; margin-top:40px;"><img src="application/images/voltar1.png" title="Voltar" border="none" /></a> 

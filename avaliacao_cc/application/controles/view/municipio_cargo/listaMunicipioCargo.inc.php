	...
	if($_GET['filtro'] == ''){
		...
		if($_GET['tipo_filtro'] == 'car_codigo'){
			...
			if($_GET['tipo_filtro'] == 'car_descricao'){
				$sql .= ' ORDER BY car_descricao ASC';	
			}else{
				$sql .= '';	
			}
	}
	...
	?>
            <div class="listagem" style="margin-bottom: 5px; background-color: #F0F5FF; padding: 5px;">
                <div class="linha_sol" style="width: 100%;">
                        ...
                        <div class="coluna" style="float:left; width: 50px;"><?php echo $result[$i]['car_codigo'];?></div>
                        <div class="coluna" style="float: left; width: 450px; margin-left: 10px;"><?php echo $result[$i]['car_descricao'];?></div>
                        <?php 

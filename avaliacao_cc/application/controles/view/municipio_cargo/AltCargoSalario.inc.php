<?php
	...
	$sql = "SELECT *
			FROM municipio_cargo AS mc 
				LEFT JOIN municipio_cargo_funcao AS mcf ON (mc.car_codigo = mcf.car_codigo)
...
<div id="table">
	<h2>Alterar Cargos - salario</h2>
		
        <form action="?module=controles&acao=update_cargo_salario_funcao" id="frmCadastro" method="post">
            ...
            <!-- Botão Voltar -->        
            <div class="coluna" >
                <a href="?module=controles&acao=edita_cargo_seleciona&mun_codigo=<?php echo $_POST['mun_codigo'];  ?>"><img src="application/images/voltar.png" /></a>
            </div>

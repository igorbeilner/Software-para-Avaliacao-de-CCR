...
<body>
	<div id="geral">
		...
		<div id="container">
      		<div id="boasvindas"> 
            	<br /><br />
            	<p style="color:#999;">EFETUE LOGIN, CASO ESQUECEU SUA SENHA ENVIE UM EMAIL OU LIGUE PARA A AMOSC.</p>
          		<a href="mailto:informatica1@amosc.org.br">informatica1@amosc.org.br</a> 
      		</div>
    		...
    		<div style="background-color: #f0f0f0; left:-120px; position:relative; width:325px; top:-70px;" id="conteudo">
    			...
    			<form id="login" action='?module=index&action=valida_senha' method="post">	
                    ...
                    <input type="password"  name="senha" placeholder="Insira aqui sua senha"/><br />

<?php
	...
	$sql = "SELECT pro_permissao
			FROM professor
			WHERE pro_cpf = ".$_SESSION['userId'];
	...
	if($_GET['filtro'] == ''){
		...
		if($_GET['tipo_filtro'] == 'pro_codigo'){
			$sql .= ' ORDER BY pro_codigo ASC';	
		}else
	...
	?>
            <div class="listagem" style="margin-bottom: 5px; background-color: #F0F5FF; padding: 5px;">
                <div class="linha_sol" style="width: 100%;">
                        ...
                        <div class="coluna" style="float:left; width: 50px;"><?php echo $result[$i]['pro_codigo'];?></div>
